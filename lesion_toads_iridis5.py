...
# See: https://nipype.readthedocs.io/en/latest/api/generated/nipype.interfaces.mipav.developer.html
...
def lesion_toads(T1_image, FLAIR_image):
    ...
    # (27 Aug 2021) add inAtlas
    # lesion_toads.inputs.inAtlas = "With Lesion"
    ...
    # (27 Aug 2021) add inAtlas6
    # lesion_toads.inputs.inAtlas6 ='rigid'
    lesion_toads.inputs.inT1_MPRAGE = T1_image
    lesion_toads.inputs.inFLAIR = FLAIR_image
    # (27 Aug 2021) add inOutput
    # lesion_toads.inputs.inOutput = 'cruise inputs'
    # (31 Aug 2021) Commented out because absolute path is needed
    # https://stackoverflow.com/questions/51520/how-to-get-an-absolute-file-path-in-python
    lesion_toads.inputs.outHard = os.path.abspath(os.path.join(toads_directory, out_mask + '_alllabels.nii.gz'))
    lesion_toads.inputs.outLesion = os.path.abspath(os.path.join(toads_directory, out_mask  + '_lesionseg.nii.gz'))
